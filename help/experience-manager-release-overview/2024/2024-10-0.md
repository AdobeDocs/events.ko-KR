...
description: 이 릴리스의 기능은 Experience Manager Assets 및 Cloud Service의 혁신에 중점을 두고 있으며, 다음과 같은 기능이 포함됩니다. Assets Ultimate 및 Asset PrimeAEM AEM Assets을 통한 AEM Assets의 새로운 가격 및 패키징 추가 대상으로 로그 전달 비즈니스 사용자를 위한 파이프라인 없는 URL 리디렉션 ​ RDE 지원 Config Pipeline YAMLs​ Interactive AEM Cloud Service
