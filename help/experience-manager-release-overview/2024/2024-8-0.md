...
이 이벤트는 라이브 카피 또는 다중 사이트 관리자 기능의 도입을 포함하여 Adobe Experience Manager에 대한 업데이트를 제공했으며, 이를 통해 사용자는 다양한 변형을 통해 여러 위치의 콘텐츠를 쉽게 관리할 수 있습니다. 또한 이벤트&#x200B;은 에셋 관리를 위한 새로운 Firefly 개선 사항을 보여주며 검색 결과가 없는 경우 사용자가 새 에셋을 생성할 수 있도록 합니다. 또한 다이내믹 미디어 템플릿&#x200B;을 도입하여 값을 효율적으로 변경하여 여러 배너를 간편하게 만들 수 있습니다. 또한 AM 양식&#x200B;을 위한 새로운 Jenn-air 시스템을 강조하여 양식 생성 프로세스를 가속화하는 얼리 어답터 액세스를 제공합니다. 마지막으로&#x200B;, 프로젝트 배포 간소화를 위해 Edge Delivery Services 지원 및 도메인 검증 DB 인증서 등 Cloud Manager에 대한 개선 사항이 제시되었습니다. &#x200B;
