...
이 세션에 참여하여 고객이 DAM의 성능을 저하시키고 낮은 사용자 채택에 기여하는 일반적인 전략 실수에 대한 통찰력을 얻으십시오. 고객 성공 관리자 Andrea Hardeman과 AEM 건축가 Tommy Miller가 복합 시나리오 기반 접근 방식을 안내하고 다른 고객의 과제에서 얻은 지식을 활용하는 방법을 보여 줍니다.
