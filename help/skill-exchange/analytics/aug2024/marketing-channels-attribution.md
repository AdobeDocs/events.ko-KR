...
* Adobe Analytics 구성: 캠페인 추적 코드 설정, 관련 데이터 캡처 및 효율적인 데이터 수집을 위한 Adobe Launch 활용에 대한 실용적인 지식을 얻으십시오.
  ...
  이 세션에 포함된 캠페인 추적 코드 생성기 도구를 다운로드하려면 Experience League Perspective의 [Adobe Analytics 마케팅 채널 및 속성 마스터하기](https://experienceleague.adobe.com/en/perspectives/mastering-adobe-analytics-marketing-channels-attribution)를 방문하십시오.
