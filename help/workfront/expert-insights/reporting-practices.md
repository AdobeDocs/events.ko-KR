...
* **문서** - [계산된 데이터 표현식]&#x200B;(https://experienceleague.adobe.com/docs/workfront/using/reporting/reports/calculated-custom-data/calculated-data-expressions.html?lang=en#:~:text=새 필드를 생성하는 데이터 표현식을 사용할 수 있습니다.&amp;text=데이터를 사용자 정의 양식으로 만드는 방법에 대한 자세한 정보입니다.)
