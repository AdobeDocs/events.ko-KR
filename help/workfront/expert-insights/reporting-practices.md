...
description: Nichole Vargas에서 주요 보고 사례를 학습하여 계산된 필드, storytelling 팁 및 커뮤니티 주도 리소스를 통해 Workfront 보고 기술을 향상시킵니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3469972/?captions=kor&learn=on&enablevpops)
...
* **문서** - [계산된 데이터 표현식]&#x200B;(https://experienceleague.adobe.com/docs/workfront/using/reporting/reports/calculated-custom-data/calculated-data-expressions.html?lang=ko#:~:text=새 필드를 생성하는 데이터 표현식을 사용할 수 있습니다.&amp;text=데이터를 사용자 정의 양식으로 만드는 방법에 대한 자세한 정보입니다.)
