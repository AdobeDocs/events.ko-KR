---
title: Workfront Team of One의 고백
description: 단일 관리자가 어떻게 Workfront을 강력한 운영 엔진으로 전환하여 Penn State의 OEC에서 효율성과 혁신을 주도하는지 알아보십시오.
...
# Workfront Team of One의 고백

펜실베니아 주 기업가정신 및 상업화 사무소의 프로젝트 관리자인 Kat Shondeck이 단일 Workfront 시스템 관리자가 전체 부서를 성공적으로 지원하고, 모든 프로젝트를 관리하며, 기존의 프로젝트 관리를 훨씬 뛰어넘는 혁신적인 워크플로를 구축하는 방법에 대해 자세히 살펴볼 수 있도록 지원합니다.

온디맨드 녹화를 시청하여 실용적인 전략, 창의적인 Workfront 구성 및 Workfront을 재무 요청, 접수, 보고 및 룸 임대 관리를 위한 운영 엔진으로 사용하는 실제 사례를 살펴보십시오.
