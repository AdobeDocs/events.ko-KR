---
title: 거버넌스, 실행 및 채택을 위한 Workfront Pro 팁
description: Workfront 인스턴스의 감독 및 작업을 개선하는 우수 사례, 팁, 요령 및 비밀입니다.
...
# 거버넌스, 실행 및 채택을 위한 Workfront Pro 팁

Enterprise Architecture와 협력하여 호스팅된 이 웨비나는 Workfront 인스턴스의 감독 및 작업을 개선하기 위한 모범 사례, 팁, 요령 및 비밀을 공유했습니다.

거버넌스(이름 지정 규칙 고려), 실행(프로세스 및 자동화) 및 채택(레이아웃 템플릿, 보기, 필터 및 그룹화)에 중점을 둔 이 세션은 Workfront을 성공적으로 사용할 수 있도록 설정하는 데 유용한 힌트로 가득 찼습니다.
