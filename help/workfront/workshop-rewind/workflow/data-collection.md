---
title: Workfront Pro 팁 - Workfront의 다음 수준 데이터 수집 기회
description: Workfront의 데이터 수집을 최적화하여 효율성과 거버넌스를 높이기 위한 고급 기술을 살펴보십시오.
...
# Workfront Pro 팁 - Workfront의 다음 수준 데이터 수집 기회

Steve Teitelbaum, Adobe의 Enterprise Architect Content Supply chain과 협력하여 Workfront 사용자 정의 양식 및 비즈니스 규칙의 고급 기능이 데이터 수집 방법과 이를 통해 운영, 보고, Workfront 통합 및 AI 사용 사례를 간소화하는 방법을 더욱 세밀하게 제어하는 방법에 대해 알아보십시오.
