...
조직이 성장함에 따라 온보딩, 교육 및 사용자 지원의 복잡성도 증가합니다. 소규모 파일럿 팀에서 작동하는 것은 종종 규모에 맞게 중단됩니다. Adobe Workfront 블루프린트 및 프로젝트 템플릿에서 구조, 일관성 및 속도를 제공할 수 있습니다. 이 세션에서는 Workfront이 어떻게 블루프린트에서 제공하는 교육 및 활성화를 위해 엔진을 구동할 수 있는지 살펴봅니다.
