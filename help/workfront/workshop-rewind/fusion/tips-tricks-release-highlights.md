...
새로운 기능, 업데이트 및 향후 로드맵 계획을 공유하려면 수석 제품 관리자인 Sam Taylor와 함께 하십시오. 주요 주제에는 디자인 경험 개선 사항, 재사용 가능한 논리에 대한 연결된 시나리오, 경고/모니터링, 이벤트 우선 순위, 기술 계정 활용 및 인스턴스 성능 모니터링 대시보드가 포함됩니다.
