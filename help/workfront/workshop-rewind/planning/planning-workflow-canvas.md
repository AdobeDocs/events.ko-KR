...
성공적인 조직은 계획, 실행 및 보고를 별도의 활동으로 취급하지 않으며, 이를 연결합니다. 이 세션에서는 Workfront 전문가인 Madalyn Destaffney가 Workfront Planning을 Workfront 워크플로와 함께 활용하여 계획 수립에서 실행으로 원활하게 이동하는 연결된 운영 모델을 만드는 방법을 공유하며, 이는 Canvas Dashboards를 통해 실시간으로 볼 수 있습니다.
