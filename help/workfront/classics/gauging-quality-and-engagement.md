...
반복에서 기본 작업 역할을 식별할 수 있습니다. valueexpression에서 이 작업을 수행해야 하지만 HTML 코드는 valueexpression에서 인식되지 않습니다. 그래서 우리는 그 역할을 1차적인 것으로 파악하는 다른 방법을 생각해내야 한다. 이 코드에서 기본 역할 이름 앞과 뒤에 &quot;**&quot;을 넣습니다. 한 번 시도해보고 어떤지 봐보세요.
