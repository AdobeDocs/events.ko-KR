---
title: Adobe Workfront 2025년 4분기 릴리스 웨비나
description: 이 웨비나에서는 새 요청 경험, AI 검토자, 업무 균형자 업데이트와 계획 및 Fusion 기능을 포함하여 새로운 개선 사항이 강조되었습니다
...
# Adobe Workfront 2025년 4분기 릴리스 웨비나

Workfront 4분기 릴리스는 2025년 10월 16일에 배포되었습니다.   Adobe 제품 관리 팀과 공동으로 호스팅된 이 웨비나에서는 새로운 요청 경험, AI 검토자, 업무 균형자 업데이트, 계획 및 Fusion 기능 등을 포함하여 새로운 개선 사항이 강조되었습니다.

>[!VIDEO](https://video.tv.adobe.com/v/3477133/?learn=on&enablevpops)

라이브 세션에 참석할 수 없다면 걱정하지 마세요! [슬라이드 데크](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/100925+-+Fourth+Quarter+Release+Webinar.pdf)를 검토하고 온디맨드 녹화를 시청하여 계속 진행하십시오.
