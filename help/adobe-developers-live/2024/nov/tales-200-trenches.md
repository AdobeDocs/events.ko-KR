...
200개 이상의 Edge Delivery Services 프로젝트가 완료됨에 따라 Adobe 수석 엔지니어인 Kiran Muruguulla와 Adobe Experience Manager Cloud의 설계자인 Varun Mitra는 배운 주요 교훈을 공유합니다. 뛰어난 Core Web Vitals을 통해 빠르고 성능이 뛰어난 경험을 제공하는 비결에 대해 알아보십시오.
