...
description: Adobe Experience Manager as a Headless CMS - 장소/시기/이유?이 세션에서는 여러 가지 방법으로 Adobe Experience Manager을 통해 Headless CMS을 구현하는 방법을 알아봅니다. 이 세션은 다음 사항을 다룹니다. 내보내기/서블릿을 통한 콘텐츠 서비스 자산 API를 통한 콘텐츠 조각(데모) Graphql을 통한 콘텐츠 조각(데모) 콘텐츠 조각 사용과 관련된 일부 실시간 사용 사례 및 접근 방식 SPA 편집기 학습(선택 시기에 대한 일부 솔루션 접근 방식) (데모)
...
이 세션에서는 여러 가지 방법으로 Adobe Experience Manager을 통해 Headless CMS을 구현하는 방법을 알아봅니다. 이 세션은 다음 내용을 다룹니다.
