...
description: UI 확장성 및 새 콘텐츠 조각 소개 UIAdobe Experience Manager은 유지 관리 비용을 절감하고, 사용자에게 최신 개선 사항을 지속적으로 제공하며, 최신 프런트 엔드 기술 스택으로 사용자 정의 및 확장할 수 있는 새로운 서비스를 제공합니다.이 세션에서는 새로운 콘텐츠 조각 UI 서비스에 대한 개요를 만들고 콘텐츠 조각 콘솔용 확장을 만드는 방법에 대한 단계별 예를 제공합니다.
