---
title: AI를 통한 정부 서비스 능률화
description: AI와 Adobe-Microsoft 통합으로 정부 디지털 서비스를 개선하고 시민 액세스를 향상하며 워크플로우를 간소화하는 방법을 살펴봅니다.
role: Developer, User
...
# AI 및 Adobe-Microsoft 통합을 활용하여 정부 디지털 서비스 간소화
