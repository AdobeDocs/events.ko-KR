---
title: 하계 스포트라이트 - 꼭 사용해 봐야 하는 Adobe Journey Optimizer 기능 세 가지
description: Adobe Journey Optimizer의 세 가지 기능인 여정 실험, 빈도 상한 설정, 다국어 메시징을 사용하여 이번 여름 고객 참여를 극대화하세요.
kt: 15471
...
# 하계 스포트라이트 - 꼭 사용해 봐야 하는 Adobe Journey Optimizer 기능 세 가지
...
**세부 정보 표시**:
여름이 더워짐에 따라 새롭고 영향력 있는 방식으로 고객과 교류할 수 있는 기회도 마련됩니다. 마케팅 운영, 캠페인/여정 관리 또는 Adobe Journey Optimizer의 강력한 기능을 살펴볼 수 있는 고객 경험 등 Journey Optimizer 실무자를 위한 1시간 Experience League Live에 참여하십시오.
