...
이 세션에서는 Adobe 전문가 Ariel Sultan과 Aaron Forrest가 고객 메시지를 정확하게 관리하고 우선 순위를 지정할 수 있도록 지원하는 Adobe Journey Optimizer의 새로운 기능에 대해 자세히 설명했습니다. 이들은 메시지 피로도를 줄이고 충돌을 해결하며 고객이 공감할 만한 효과적인 경험을 전달하는 방법을 보여 주었습니다.
...
* [인바운드 작업에 우선순위 점수 할당](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/conflict-management/assign-priority-score)
