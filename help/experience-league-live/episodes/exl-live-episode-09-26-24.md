---
title: AI Bash - Adobe Experience Platform 애플리케이션 및 Campaign에서 AI 어시스턴트 기능 활용하기
description: AI 기반 도구는 고객 참여를 유도하고 워크플로우를 간소화하는 방식을 혁신하고 있습니다. AI를 주제로 하는 Experience League Live 웨비나에 참여하여 혁신의 속도를 높이고 Adobe의 기능이 생산성을 어떻게 가속화하는지 알아보십시오. 
kt: KT-15472
...
# AI Bash - Adobe Experience Platform 애플리케이션 및 Campaign에서 AI 어시스턴트 기능 활용하기
...
AI 기반 도구는 고객 참여를 유도하고 워크플로우를 간소화하는 방식을 혁신하고 있습니다. AI를 주제로 하는 Experience League 라이브 쇼에 참여하여 혁신의 속도를 유지하고 Adobe의 기능이 생산성을 어떻게 가속화하는지 알아보십시오.
