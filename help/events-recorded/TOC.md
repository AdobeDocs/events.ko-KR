...
+ 계열별 {#series}
   ...
   + [Adobe Commerce 웨비나](https://experienceleague.adobe.com/docs/events/adobe-commerce-webinars/overview.html?lang=ko)
   ...
   + [Workfront 시작](https://experienceleague.adobe.com/docs/events/wake-up-with-workfront-recordings/overview.html?lang=ko)
