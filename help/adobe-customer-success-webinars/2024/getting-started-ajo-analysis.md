...
* Adobe Journey Optimizer의 태그와 카테고리를 여정 및 캠페인에 적용하여 효과적으로 필터링하고 그룹화할 수 있으므로 다양한 기준을 기반으로 성과를 분석하고 측정하는 방법을 제공합니다.

* Adobe Journey Optimizer Analytics에서 애자일 데이터를 활용하기 위한 구성 및 설정 프로세스에는 연결, 데이터 보기 및 지표 생성이 포함되며, 이는 사용자가 데이터에 효과적으로 액세스하고 활용할 수 있도록 관리자가 일회성 작업을 수행할 수 있습니다.
