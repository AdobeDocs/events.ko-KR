...
# Adobe 솔루션을 사용한 Edge Network 및 Mobile Personalization에 대한 통찰력

Edge 아키텍처의 작동 방식과 Assurance을 사용하여 구현을 디버깅하는 방법을 이해합니다
모바일 SDK 설정 및 구성 방법에 대한 기술 지침
...
### Edge Network 및 Mobile Personalization에 집중:
...
* 최적화를 위해 최신 SDK 버전으로 마이그레이션 또는 Mobile Edge SDK 사용.
