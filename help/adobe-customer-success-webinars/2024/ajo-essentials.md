...
* 이 세션에서는 Adobe Journey Optimizer의 캠페인과 여정의 구별에 대해 다룹니다. 캠페인&#x200B;은 홍보 이메일과 같은 일회성 커뮤니케이션용으로 디자인된 반면, 여정은 웹 사이트 방문 또는 구매와 같은 실시간 이벤트에 의해 트리거되는 시간에 따라 펼쳐지는 동적이고 개인화된 상호 작용을 위한 것입니다. &#x200B;

* 웨비나에서는 이메일 캠페인을 보완하는 데 있어 랜딩 페이지의 중요성에 대해 논의하고, 개인화된 대상을 허용하여 고객 참여 및 작업을 장려합니다. 랜딩 페이지&#x200B;은 고객을 여정에 따라 안내하여 리드를 캡처하고 구독자 목록을 빌드하며 전체 고객 경험을 향상시킬 수 있습니다. &#x200B;
