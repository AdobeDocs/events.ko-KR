...
>[!VIDEO](https://video.tv.adobe.com/v/3455008/?captions=kor&learn=on)

이 세션에서는 발표자가 Adobe Acrobat Sign을 사용하여 계약을 관리하고 추적하는 방법에 대해 설명합니다. 다양한 계약 상태&#x200B;을 설명하고 진행 중인 계약에서 수행할 수 있는 작업을 보여 주며 추가 학습을 위한 리소스를 제공합니다.
